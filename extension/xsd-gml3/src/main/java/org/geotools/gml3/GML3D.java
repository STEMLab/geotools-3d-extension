 ...
 * @source $URL$
 */
public final class GML3D extends XSD {
     ...
     * singleton instance.
     */
    private static GML3D instance = new GML3D();

    /**
     * The singleton instance;
     */
    public static GML3D getInstance() {
        return instance;
    }
    ...
    public Schema buildTypeMappingProfile(Schema typeSchema) {
        ...
        //basic
        profile.add(name(GML3D.MeasureType));

        //geomtetries
        profile.add(name(GML3D.PointPropertyType));
        profile.add(name(GML3D.MultiPointPropertyType));
        profile.add(name(GML3D.LineStringPropertyType));
        profile.add(name(GML3D.MultiLineStringPropertyType));
        profile.add(name(GML3D.CurvePropertyType));
        profile.add(name(GML3D.MultiCurvePropertyType));
        profile.add(name(GML3D.SurfacePropertyType));
        profile.add(name(GML3D.MultiSurfacePropertyType));
        ...
        profile.add(name(GML3D.PolygonPropertyType));
        profile.add(name(GML3D.MultiPolygonPropertyType));

        //profile.add( new NameImpl(  GML.NAMESPACE, GML.AbstractGeometryType ) );
        profile.add(name(GML3D.GeometryPropertyType));
        profile.add(name(GML3D.MultiGeometryPropertyType));
