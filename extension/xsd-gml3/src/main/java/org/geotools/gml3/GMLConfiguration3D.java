...
import org.geotools.gml3.bindings.AbstractFeatureTypeBindingExt;
...
import org.geotools.gml3.bindings.GeometryPropertyTypeBindingExt;
...
import org.geotools.gml3.bindings.ext.AbstractGeometryTypeBindingExt;
import org.geotools.gml3.bindings.ext.CompositeCurveTypeBinding;
import org.geotools.gml3.bindings.ext.GML3EncodingUtils3D;
import org.geotools.gml3.bindings.ext.SurfacePropertyTypeBindingExt;
 ...
 * @source $URL$
 */
public class GMLConfiguration3D extends Configuration {
     ...
     */
    boolean extArcSurfaceSupport = true;
    ...
    public GMLConfiguration3D() {
        this(false);
    }
    
    public GMLConfiguration3D(boolean extArcSurfaceSupport) {
        super(GML3D.getInstance());
    ...
    protected void registerBindings(MutablePicoContainer container) {
        //Types
        container.registerComponentImplementation(GML3D.AbstractFeatureType,
            AbstractFeatureTypeBindingExt.class);
        container.registerComponentImplementation(GML3D.AbstractFeatureCollectionType,
            AbstractFeatureCollectionTypeBinding.class);
        container.registerComponentImplementation(GML3D.AbstractGeometryType,
            AbstractGeometryTypeBindingExt.class);
        container.registerComponentImplementation(GML3D.AbstractRingPropertyType,
            AbstractRingPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.BoundingShapeType,
            BoundingShapeTypeBinding.class);
        //container.registerComponentImplementation(GML.COORDINATESTYPE,CoordinatesTypeBinding.class);
        container.registerComponentImplementation(GML3D.CoordinatesType,
            GMLCoordinatesTypeBinding.class);
        //container.registerComponentImplementation(GML.COORDTYPE,CoordTypeBinding.class);
        container.registerComponentImplementation(GML3D.CoordType, GMLCoordTypeBinding.class);
        container.registerComponentImplementation(GML3D.CurveArrayPropertyType,
            CurveArrayPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.CurveType, CurveTypeBinding.class);
        container.registerComponentImplementation(GML3D.CurvePropertyType,
            CurvePropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.CurveSegmentArrayPropertyType,
            CurveSegmentArrayPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.DirectPositionListType,
            DirectPositionListTypeBinding.class);
        container.registerComponentImplementation(GML3D.DirectPositionType,
            DirectPositionTypeBinding.class);
        container.registerComponentImplementation(GML3D.doubleList, DoubleListBinding.class);
        container.registerComponentImplementation(GML3D.EnvelopeType, EnvelopeTypeBinding.class);
        container.registerComponentImplementation(GML3D.FeatureArrayPropertyType,
            FeatureArrayPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.FeaturePropertyType,
            FeaturePropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.GeometryPropertyType,
            GeometryPropertyTypeBindingExt.class);
        container.registerComponentImplementation(GML3D.integerList, IntegerListBinding.class);
        container.registerComponentImplementation(GML3D.LinearRingPropertyType,
            LinearRingPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.LinearRingType, LinearRingTypeBinding.class);
        container.registerComponentImplementation(GML3D.LineStringPropertyType,
            LineStringPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.LineStringSegmentType,
            LineStringSegmentTypeBinding.class);
        container.registerComponentImplementation(GML3D.LineStringType, LineStringTypeBinding.class);
        container.registerComponentImplementation(GML3D.LocationPropertyType,
            LocationPropertyTypeBinding.class);

        container.registerComponentImplementation(GML3D.MeasureType, MeasureTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiCurveType, MultiCurveTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiCurvePropertyType,
            MultiCurvePropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiGeometryType, MultiGeometryTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiGeometryPropertyType, MultiGeometryPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiLineStringPropertyType,
            MultiLineStringPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiLineStringType,
            MultiLineStringTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiPointPropertyType,
            MultiPointPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiPointType, MultiPointTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiPolygonPropertyType,
            MultiPolygonPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiPolygonType,
            MultiPolygonTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiSurfaceType,
            MultiSurfaceTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiSurfacePropertyType,
            MultiSurfacePropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.NullType,
                NullTypeBinding.class);
        container.registerComponentImplementation(GML3D.PointArrayPropertyType,
            PointArrayPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.PointPropertyType,
            PointPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.PointType, PointTypeBinding.class);
        container.registerComponentImplementation(GML3D.PolygonPatchType,
                PolygonPatchTypeBinding.class);
        container.registerComponentImplementation(GML3D.PolygonPropertyType,
            PolygonPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.PolygonType, PolygonTypeBinding.class);
        container.registerComponentImplementation(GML3D.ReferenceType, ReferenceTypeBinding.class);
        container.registerComponentImplementation(GML3D.SurfaceArrayPropertyType,
        ...
        container.registerComponentImplementation(GML3D.SurfaceType, SurfaceTypeBinding.class);
        
        container.registerComponentImplementation(GML3D.TimeInstantType, TimeInstantTypeBinding.class);
        container.registerComponentImplementation(GML3D.TimeInstantPropertyType, TimeInstantPropertyTypeBinding.class);
        container.registerComponentImplementation(GML3D.TimePeriodType, TimePeriodTypeBinding.class);
        container.registerComponentImplementation(GML3D.TimePositionType, TimePositionTypeBinding.class);
        container.registerComponentImplementation(GML3D.TimePositionUnion, TimePositionUnionBinding.class);
        
        container.registerComponentImplementation(XS.ANYTYPE, ComplexSupportXSAnyTypeBinding.class);

        container.registerComponentImplementation(GML3D.ArcStringType, ArcStringTypeBinding.class);
        container.registerComponentImplementation(GML3D.ArcType, ArcTypeBinding.class);
        container.registerComponentImplementation(GML3D.RingType, RingTypeBinding.class);
        container.registerComponentImplementation(GML3D.CompositeCurveType,
        ...
        container.registerComponentImplementation(GML3D.CurveType,
                org.geotools.gml3.bindings.ext.CurveTypeBinding.class);
        container.registerComponentImplementation(GML3D.MultiCurveType,
        ...
        if (isExtendedArcSurfaceSupport()) {
            ...
            container.registerComponentImplementation(GML3D.CircleType,
                    CircleTypeBinding.class);
            container.registerComponentImplementation(GML3D.SurfacePatchArrayPropertyType,
            ...
            container.registerComponentImplementation(GML3D.SurfaceType, 
    ...
    public void configureContext(MutablePicoContainer container) {
        ...
        container.registerComponentInstance(new GML3EncodingUtils3D());
