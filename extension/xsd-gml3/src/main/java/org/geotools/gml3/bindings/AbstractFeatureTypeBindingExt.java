...
import org.geotools.gml3.bindings.ext.GML3ParsingUtils3D;
 ...
 * @source $URL$
 */
public class AbstractFeatureTypeBindingExt extends AbstractComplexBinding {
    FeatureTypeCache ftCache;
    XSDIdRegistry idSet;
    BindingWalkerFactory bwFactory;
    SchemaIndex schemaIndex;
    Configuration configuration;
    GML3EncodingUtils3D encodingUtils;
    
    public AbstractFeatureTypeBindingExt(FeatureTypeCache ftCache, BindingWalkerFactory bwFactory,
            SchemaIndex schemaIndex, Configuration configuration, XSDIdRegistry idRegistry, GML3EncodingUtils3D encodingUtils ) {
    ...
    public QName getTarget() {
        return GML3D.AbstractFeatureType;
    }
    ...
    public Object parse(ElementInstance instance, Node node, Object value)
        throws Exception {
        return GML3ParsingUtils3D.parseFeature(instance, node, value, ftCache, bwFactory);
