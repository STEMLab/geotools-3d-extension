 ...
 * @source $URL$
 */
public abstract class GeometryPropertyTypeBindingBaseExt extends AbstractComplexBinding {

    private XSDIdRegistry idSet;

    private boolean makeEmpty = false;

    private GML3EncodingUtils3D encodingUtils;

    public GeometryPropertyTypeBindingBaseExt(GML3EncodingUtils3D encodingUtils, XSDIdRegistry idRegistry) {
    ...
    public Object getProperty(Object object, QName name) throws Exception {
        ...
        return encodingUtils.GeometryPropertyType_GetProperty(object, name, makeEmpty);
    }
    ...
    private void checkExistingId(Object geom) {
        if (geom != null && geom.getClass().isAssignableFrom(Geometry.class)) {
            String id = GML2EncodingUtils.getID((Geometry) geom);
