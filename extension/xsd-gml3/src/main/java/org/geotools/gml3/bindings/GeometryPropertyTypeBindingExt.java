 ...
 */
public class GeometryPropertyTypeBindingExt extends GeometryPropertyTypeBindingBaseExt {

    public GeometryPropertyTypeBindingExt(GML3EncodingUtils3D encodingUtils, XSDIdRegistry idRegistry) {
    ...
    public QName getTarget() {
        return GML3D.GeometryPropertyType;
    }
