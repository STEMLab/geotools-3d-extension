 ...
 * @source $URL$
 */
public class SurfacePropertyTypeBinding extends GeometryPropertyTypeBindingExt
    implements Comparable {

    GeometryFactory gf;
    
    public SurfacePropertyTypeBinding(GML3EncodingUtils3D encodingUtils, XSDIdRegistry idRegistry, GeometryFactory gf) {
