...
public class GMLConfiguration3D extends Configuration {
     ...
     */
    public static final QName NO_SRS_DIMENSION = org.geotools.gml3.GMLConfiguration3D.NO_SRS_DIMENSION;

    /**
     * Property which engages "fast" gml encoding.
     */
    public static final QName OPTIMIZED_ENCODING = org.geotools.gml3.GMLConfiguration3D.OPTIMIZED_ENCODING;

    /**
     * gml3 configuration used to delegate to for configuration
     */
    org.geotools.gml3.GMLConfiguration3D delegate;
     ...
     * 
     */  
    public GMLConfiguration3D(boolean arcSurfaceSupport) {
       super(GML.getInstance());
       delegate = new org.geotools.gml3.GMLConfiguration3D(arcSurfaceSupport);
    ...
    protected void configureContext(MutablePicoContainer container) {
        ...
        container.unregisterComponent(GML3EncodingUtils3D.class);
