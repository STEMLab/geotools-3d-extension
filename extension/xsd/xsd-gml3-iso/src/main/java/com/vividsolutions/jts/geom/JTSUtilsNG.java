...
public final class JTSUtilsNG {
    ...
    public static Geometry jtsToGo1(
        ...
        PrimitiveFactory pf = ISOGeometryFactoryFinder.getPrimitiveFactory(hints);
        GeometryFactory gf = ISOGeometryFactoryFinder.getGeometryFactory(hints);
...
/*        Object userData = jtsPolygon.getUserData();
	...
	botRight.setOrdinate(1, topCorner.getOrdinate(1));
        ...
        Coordinate jtsTopRight =
            JTSUtilsNG.directPositionToCoordinate(topCorner);
        Coordinate jtsTopLeft =
            JTSUtilsNG.directPositionToCoordinate(topLeft);
        Coordinate jtsBotLeft =
            JTSUtilsNG.directPositionToCoordinate(botCorner);
        Coordinate jtsBotRight =
            JTSUtilsNG.directPositionToCoordinate(botRight);
