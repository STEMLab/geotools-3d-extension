 ...
 */
package org.geotools.gml3.iso.complex;
...
import org.geotools.gml3.iso.smil.SMIL20Schema;
 ...
 * different version of GML class may be called upon. eg {@link org.geotools.gml3.iso.v3_2.GML} or
 * {@link org.geotools.gml3.iso.GML}
 * 
...
public class GmlFeatureTypeRegistryConfiguration implements FeatureTypeRegistryConfiguration {
    ...
    public Collection<Schema> getSchemas() {
        ...
        schemas.add(new org.geotools.gml3.iso.v3_2.GMLSchema());
        schemas.add(new org.geotools.gml3.iso.v3_2.gco.GCOSchema());
        schemas.add(new org.geotools.gml3.iso.v3_2.gmd.GMDSchema());
        schemas.add(new org.geotools.gml3.iso.v3_2.gmx.GMXSchema());
        schemas.add(new org.geotools.gml3.iso.v3_2.gsr.GSRSchema());
        schemas.add(new org.geotools.gml3.iso.v3_2.gss.GSSSchema());
        schemas.add(new org.geotools.gml3.iso.v3_2.gts.GTSSchema());                
        return schemas;
    }
    ...
    public Collection<Configuration> getConfigurations() {
        ...
        configurations.add(new org.geotools.gml3.iso.v3_2.GMLConfiguration_ISO());
        return configurations;
    }

    public QName getAbstractFeatureType() {
        if (namespace.equals(org.geotools.gml3.iso.v3_2.GML.NAMESPACE)) {
            return org.geotools.gml3.iso.v3_2.GML.AbstractFeatureType;
        } else {
            return org.geotools.gml3.iso.GML.AbstractFeatureType;
        }
    }

    public QName getAbstractGeometryType() {
        if (namespace.equals(org.geotools.gml3.iso.v3_2.GML.NAMESPACE)) {
            return org.geotools.gml3.iso.v3_2.GML.AbstractGeometryType;
        } else {
            return org.geotools.gml3.iso.GML.AbstractGeometryType;
        }
    }

    public String getNameSpace() {
        if (namespace.equals(org.geotools.gml3.iso.v3_2.GML.NAMESPACE)) {
            return org.geotools.gml3.iso.v3_2.GML.NAMESPACE;
        } else {
            return org.geotools.gml3.iso.GML.NAMESPACE;
        }
    }

    public QName getId() {
        if (namespace.equals(org.geotools.gml3.iso.v3_2.GML.NAMESPACE)) {
            return org.geotools.gml3.iso.v3_2.GML.id;
        } else {
            return org.geotools.gml3.iso.GML.id;
        }
    }
    ...
    public void setEmptyNamespace(XSDTypeDefinition typeDefinition) {
        if (namespace.isEmpty()) {
            ...
            if (isBasedOn(typeDefinition, org.geotools.gml3.iso.v3_2.GML.NAMESPACE)) {
                namespace = org.geotools.gml3.iso.v3_2.GML.NAMESPACE;
            } else if (isBasedOn(typeDefinition, org.geotools.gml3.iso.GML.NAMESPACE)) {
                namespace = org.geotools.gml3.iso.GML.NAMESPACE;
            }
        }
    }
    ...
    = new LinkedHashMap<QName, Class<? extends Configuration>>() {
        {
            ...
            // GML 3.2
            put(org.geotools.gml3.iso.v3_2.GML.AbstractFeatureType,
                    org.geotools.gml3.iso.v3_2.GMLConfiguration_ISO.class);
        }
    };
