...
public class GMLConfiguration_ISO extends Configuration {
     ...
     */
    public static final QName NO_SRS_DIMENSION = org.geotools.gml3.GMLConfiguration_ISO.NO_SRS_DIMENSION;

    /**
     * Property which engages "fast" gml encoding.
     */
    public static final QName OPTIMIZED_ENCODING = org.geotools.gml3.GMLConfiguration_ISO.OPTIMIZED_ENCODING;

    /**
     * gml3 configuration used to delegate to for configuration
     */
    org.geotools.gml3.GMLConfiguration_ISO delegate;
    ...
    public GMLConfiguration_ISO(boolean arcSurfaceSupport) {
       ...
       delegate = new org.geotools.gml3.GMLConfiguration_ISO(arcSurfaceSupport);
