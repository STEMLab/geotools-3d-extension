 ...
 * @source $URL$
 */
public final class JDBCFeatureStore3D extends ContentFeatureStore {
     ...
     */
    public JDBCFeatureStore3D(ContentEntry entry,Query query) throws IOException {
        super(entry,query);
        
        delegate = new JDBCFeatureSource3D( entry, query ) {
            @Override
            public void setTransaction(Transaction transaction) {
                super.setTransaction(transaction);
                
                //keep this feature store in sync
                JDBCFeatureStore3D.this.setTransaction(transaction);
            }
        };
    ...
    public JDBCFeatureSource3D getFeatureSource() {
        return delegate;
    }
