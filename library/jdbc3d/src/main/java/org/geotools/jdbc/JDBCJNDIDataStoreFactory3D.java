 ...
 * @source $URL$
 */
public abstract class JDBCJNDIDataStoreFactory3D extends JDBCDataStoreFactory3D {
     ...
     */
    protected JDBCDataStoreFactory3D delegate;
    
    protected JDBCJNDIDataStoreFactory3D(JDBCDataStoreFactory3D delegate) {
