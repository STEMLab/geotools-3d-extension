 ...
 *
 */
public class JDBCJoiningFilteringFeatureReader3D implements DelegatingFeatureReader<SimpleFeatureType, SimpleFeature> {

    FeatureReader<SimpleFeatureType,SimpleFeature> delegate;
    JoinInfo3D join;
    SimpleFeature next;
    
    public JDBCJoiningFilteringFeatureReader3D(FeatureReader delegate, JoinInfo3D join) {
    ...
    public boolean hasNext() throws IOException {
        ...
        while(delegate.hasNext()) {
            ...
            for (org.geotools.jdbc.JoinInfo3D.JoinPart part : join.getParts()) {
