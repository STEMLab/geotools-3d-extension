 ...
 * @source $URL$
 */
public class MetadataTablePrimaryKeyFinder3D extends PrimaryKeyFinder3D {
    protected static final Logger LOGGER = Logging.getLogger(MetadataTablePrimaryKeyFinder3D.class);
    ...
    Set<String> getColumnNames(JDBCDataStore3D store, DatabaseMetaData metaData, String schema,
    ...
    String getMetadataSchema(JDBCDataStore3D store) {
        if(tableSchema != null)
            return tableSchema;
