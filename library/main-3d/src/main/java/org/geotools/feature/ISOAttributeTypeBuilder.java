 ...
 * @source $URL$
 */
public class ISOAttributeTypeBuilder {
	 ...
	 *
	 */
    public ISOAttributeTypeBuilder() {
	 ...
	 * 
	 */
	public ISOAttributeTypeBuilder( FeatureTypeFactory factory ) {
	...
	public ISOAttributeTypeBuilder setFactory(FeatureTypeFactory factory) {
		this.factory = factory;
		return this;
	}
	 ...
	 */
	public ISOAttributeTypeBuilder init( AttributeType type ) {
	...
	public ISOAttributeTypeBuilder binding(Class binding) {
		setBinding(binding);
		return this;
	}

	public ISOAttributeTypeBuilder name(String name) {
		setName(name);
		return this;
	}

	public ISOAttributeTypeBuilder namespaceURI(String namespaceURI) {
		setNamespaceURI(namespaceURI);
		return this;
		
	}
	
	public ISOAttributeTypeBuilder crs(CoordinateReferenceSystem crs) {
		setCRS(crs);
	    return this;
	}

	public ISOAttributeTypeBuilder description(String description) {
		setDescription(description);
		return this;
	}

	public ISOAttributeTypeBuilder abstrct(boolean isAbstract) {
		setAbstract(isAbstract);
		return this;
	}

	public ISOAttributeTypeBuilder identifiable(boolean isIdentifiable) {
		setIdentifiable(isIdentifiable);
		return this;
	}

	public ISOAttributeTypeBuilder length( int length ) {
	    setLength(length);
	    return this;
	}
	
	public ISOAttributeTypeBuilder restriction(Filter restriction) {
	...
	public ISOAttributeTypeBuilder nillable(boolean isNillable) {
		setNillable(isNillable);
		return this;
	}

	public ISOAttributeTypeBuilder maxOccurs(int maxOccurs) {
		setMaxOccurs(maxOccurs);
		return this;
	}

	public ISOAttributeTypeBuilder minOccurs(int minOccurs) {
		setMinOccurs(minOccurs);
		return this;
	}
	
	public ISOAttributeTypeBuilder defaultValue(Object defaultValue) {
		setDefaultValue(defaultValue);
		return this;
	}
	
	public ISOAttributeTypeBuilder userData( Object key, Object value ) {
