...
public class ISODataUtilities {
    ...
    static {
        ...
        typeEncode.put(Curve.class, "Curve");
        typeMap.put("Curve", Curve.class);

        typeEncode.put(Surface.class, "Surface");
        typeMap.put("Surface", Surface.class);
        ...
        typeEncode.put(MultiCurve.class, "MultiCurve");
        typeMap.put("MultiCurve", MultiCurve.class);
    ...
    public static Object duplicate(Object src) {
        ...
        if (src instanceof Geometry) {
            ...
            try {
                ...
                throw new IllegalAttributeException(null, "Clone is not supported" + geometry.getClass().getName());
            }
        }
    ...
    /**
     * generate sample solid array
     * 
     * @param ISOGeometryBuilder
     * @return Array of Solids
     */
