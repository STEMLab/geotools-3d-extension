...
import org.geotools.filter.visitor.ISOBindingFilterVisitor;
 ...
 * @version $Id$
 */
public class ISOFilteringFeatureReader<T extends FeatureType, F extends Feature> implements DelegatingFeatureReader<T,F> {
     ...
     */
    public ISOFilteringFeatureReader(FeatureReader<T, F> featureReader, Filter filter) {
        this.featureReader = featureReader;
        this.filter = (Filter) filter
                .accept(new ISOBindingFilterVisitor(featureReader.getFeatureType()),
                null);
        next = null;
    }
