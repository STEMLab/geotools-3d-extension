 ...
 * @source $URL$
 */
public class ISOReTypeFeatureReader implements DelegatingFeatureReader<SimpleFeatureType,SimpleFeature> {
     ...
     */
    public ISOReTypeFeatureReader(FeatureReader<SimpleFeatureType, SimpleFeature> reader, SimpleFeatureType featureType) {
     ...
     * @since 2.3
     */
    public ISOReTypeFeatureReader(FeatureReader <SimpleFeatureType, SimpleFeature> reader, SimpleFeatureType featureType, boolean clone) {
        this.reader = reader;
    ...
    protected AttributeDescriptor[] typeAttributes(SimpleFeatureType target,
        ...
        if (ISOFeatureTypes.equalsExact(origional, target)) {
