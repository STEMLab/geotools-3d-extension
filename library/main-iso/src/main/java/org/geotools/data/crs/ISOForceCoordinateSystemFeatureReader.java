 ...
 * @version $Id$
 */
public class ISOForceCoordinateSystemFeatureReader implements  FeatureReader<SimpleFeatureType, SimpleFeature> {
     ...
     * @param schema
     */
    ISOForceCoordinateSystemFeatureReader(FeatureReader<SimpleFeatureType, SimpleFeature> reader, SimpleFeatureType schema) {
        this.reader = reader;
        this.builder = new ISOSimpleFeatureBuilder(schema);
    }
     ...
     */
    public ISOForceCoordinateSystemFeatureReader(FeatureReader<SimpleFeatureType, SimpleFeature> reader,
    ...
    public ISOForceCoordinateSystemFeatureReader(FeatureReader<SimpleFeatureType, SimpleFeature> reader,
        ...
        if (!cs.equals(originalCs)) {
            type = ISOFeatureTypes.transform(type, cs, forceOnlyMissing);
        }
        this.builder = new ISOSimpleFeatureBuilder(type);
        this.reader = reader;
    }
    ...
    public SimpleFeature next()
        ...
        return ISOSimpleFeatureBuilder.retype(next, builder);
    }
