 ...
 * @version $Id$
 */
public class ISOReprojectFeatureReader implements DelegatingFeatureReader<SimpleFeatureType, SimpleFeature>{
     ...
     */
    public ISOReprojectFeatureReader(FeatureReader <SimpleFeatureType, SimpleFeature> reader, SimpleFeatureType schema,
     ...
     */
    public ISOReprojectFeatureReader(FeatureReader<SimpleFeatureType, SimpleFeature> reader,
        ...
        try {
            for (int i = 0; i < attributes.length; i++) {
                if (attributes[i] instanceof Geometry) {
                	//TODO
                    attributes[i] = transformer.transform((com.vividsolutions.jts.geom.Geometry) attributes[i]);
                }
            }
