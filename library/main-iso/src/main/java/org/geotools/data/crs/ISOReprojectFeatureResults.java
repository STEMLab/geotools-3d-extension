 ...
 */
public class ISOReprojectFeatureResults extends AbstractFeatureCollection {
     ...
     */
    public ISOReprojectFeatureResults(FeatureCollection<SimpleFeatureType, SimpleFeature> results,
    ...
    private static SimpleFeatureType forceType( SimpleFeatureType startingType, CoordinateReferenceSystem forcedCS ) throws SchemaException{
        ...
        if (forcedCS.equals(originalCs)) {
            ...
            return ISOFeatureTypes.transform(startingType, forcedCS);
        }
    }
