 ...
 * @source $URL$
 */
public class ISOReTypingFeatureCollection extends ISODecoratingSimpleFeatureCollection {

	SimpleFeatureType featureType;
    
	public ISOReTypingFeatureCollection ( FeatureCollection<SimpleFeatureType,SimpleFeature> delegate, SimpleFeatureType featureType ) {
	    this( ISODataUtilities.simple( delegate), featureType );
	}
	public ISOReTypingFeatureCollection ( SimpleFeatureCollection delegate, SimpleFeatureType featureType ) {
		super(delegate);
