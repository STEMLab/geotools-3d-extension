 ...
 * @source $URL$
 */
public class ISODecoratingSimpleFeatureCollection implements SimpleFeatureCollection {
    ...
    protected ISODecoratingSimpleFeatureCollection(FeatureCollection<SimpleFeatureType,SimpleFeature> delegate) {
        this.delegate = ISODataUtilities.simple(delegate);
    }
    
    protected ISODecoratingSimpleFeatureCollection(SimpleFeatureCollection delegate) {
    ...
    public void accepts(org.opengis.feature.FeatureVisitor visitor,
        ...
        if (canDelegate(visitor)) {
            ...
            ISODataUtilities.visit(this, visitor, progress);
        }
    }
