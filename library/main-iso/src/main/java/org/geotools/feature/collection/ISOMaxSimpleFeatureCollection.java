 ...
 * @source $URL$
 */
public class ISOMaxSimpleFeatureCollection extends
        ISODecoratingSimpleFeatureCollection {

	SimpleFeatureCollection delegate;
	long start;
	long max;
	
    public ISOMaxSimpleFeatureCollection(FeatureCollection<SimpleFeatureType, SimpleFeature> delegate,
            long max) {
        this(ISODataUtilities.simple(delegate), 0, max);
    }

    public ISOMaxSimpleFeatureCollection(SimpleFeatureCollection delegate, long max) {
        this(delegate, 0, max);
    }

    public ISOMaxSimpleFeatureCollection(SimpleFeatureCollection delegate, long start, long max) {
        super(delegate);
	...
	public ReferencedEnvelope getBounds() {
		//calculate manually
		return ISODataUtilities.bounds( this );
	}
}
