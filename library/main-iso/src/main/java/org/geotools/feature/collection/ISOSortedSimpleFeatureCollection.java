 ...
 * 
 */
public class ISOSortedSimpleFeatureCollection extends ISODecoratingSimpleFeatureCollection {

    private SortBy[] sort;

    public ISOSortedSimpleFeatureCollection(SimpleFeatureCollection delegate, SortBy[] sort) {
        super(delegate);
        this.sort = sort;
    }
