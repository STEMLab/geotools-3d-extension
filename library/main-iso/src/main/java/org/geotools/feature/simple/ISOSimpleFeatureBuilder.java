 ...
 * @source $URL$
 */
public class ISOSimpleFeatureBuilder extends FeatureBuilder<FeatureType, Feature> {
    /**
     * logger
     */
        ...
        if ( value == null ) {
            ...
            if (!descriptor.isNillable()) {
                ...
                if ( value == null ) {
                    ...
                    value = ISODataUtilities.defaultValue(descriptor.getType().getBinding());
                }
            }
        } else {
    ...
    */
    public ISOSimpleFeatureBuilder userData( Object key, Object value ) {
        return setUserData(next, key, value);
    }
    
    @SuppressWarnings("unchecked")
    public ISOSimpleFeatureBuilder setUserData(int index, Object key, Object value) {
        if (userData == null) {
     ...
     * @return
     */
    public ISOSimpleFeatureBuilder featureUserData(Object key, Object value) {
        if(featureUserData == null) {
