 ...
 * @source $URL$
 */
public class ISOSimpleFeatureImpl implements SimpleFeature {
     ...
     * @param id
     */
    public ISOSimpleFeatureImpl( List<Object> values, SimpleFeatureType featureType, FeatureId id) {
     ...
     * @param validating
     */
    public ISOSimpleFeatureImpl(Object[] values, SimpleFeatureType featureType, FeatureId id, boolean validating) {
     ...
     */
    public ISOSimpleFeatureImpl(Object[] values, SimpleFeatureType featureType, 
    ...
    public GeometryAttribute getDefaultGeometryProperty() {
        ...
        if(geometryDescriptor != null){
            ...
            geometryAttribute = new ISOGeometryAttributeImpl(defaultGeometry, geometryDescriptor, null);            
        }
    ...
    public Property getProperty(String name) {
        ...
        if(idx == null){
            ...
            if(descriptor instanceof GeometryDescriptor){
                return new ISOGeometryAttributeImpl(values[index], (GeometryDescriptor) descriptor, null); 
            }else{
    ...
    class SimpleGeometryAttribute extends Attribute implements GeometryAttribute {
        ...
        public BoundingBox getBounds() {
            ...
            if (value instanceof Geometry) {
                bounds.expandToInclude(ReferencedEnvelope.reference(((Geometry) value).getEnvelope()));
            }
            return bounds;
        }
