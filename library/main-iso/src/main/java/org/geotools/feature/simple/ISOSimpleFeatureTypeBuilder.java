 ...
 * @source $URL$
 */
public class ISOSimpleFeatureTypeBuilder {
    /**
     * logger
     */
	 ...
	 * attribute builder
	 */
	protected ISOAttributeTypeBuilder attributeBuilder;
	 ...
	 */
	public ISOSimpleFeatureTypeBuilder() {
	 ...
	 */
	public ISOSimpleFeatureTypeBuilder(FeatureTypeFactory factory) {
		this.factory = factory;
		
		attributeBuilder = new ISOAttributeTypeBuilder();
	 ...
	 * </p>
	 */
	public ISOSimpleFeatureTypeBuilder minOccurs( int minOccurs ) {
	 ...
	 * </p>
	 */
	public ISOSimpleFeatureTypeBuilder maxOccurs( int maxOccurs ) {
	 ...
	 * </p>
	 */
	public ISOSimpleFeatureTypeBuilder nillable( boolean isNillable ) {
     ...
     */
    public ISOSimpleFeatureTypeBuilder length( int length) {
	 ...
	 * </p>
	 */
	public ISOSimpleFeatureTypeBuilder restriction( Filter filter ) {
     ...
     * </p>
	 */
	public ISOSimpleFeatureTypeBuilder restrictions( List<Filter> filters ) {
	 ...
	 * </p>
	 */
	public ISOSimpleFeatureTypeBuilder description( String description ) {
	 ...
	 * </p>
	 */
	public ISOSimpleFeatureTypeBuilder defaultValue( Object defaultValue ) {
     ...
     * </p>
     */
    public ISOSimpleFeatureTypeBuilder crs(CoordinateReferenceSystem crs) {
	 ...
	 */
	public ISOSimpleFeatureTypeBuilder srs( String srs ) {
	    if ( srs == null ) {
	        return crs( null );
	    }
	 ...
	 */
	public ISOSimpleFeatureTypeBuilder srid( Integer srid ) {
	    if ( srid == null ) {
	        return crs( null );
	    }
	 ...
	 */
	public ISOSimpleFeatureTypeBuilder userData( Object key, Object value ) {
	 ...
	 * </p>
	 */
	public ISOSimpleFeatureTypeBuilder descriptor( AttributeDescriptor descriptor ) {
	...
	public void add(String name, Class<?> binding, Integer srid) {
         ...
         * @param descriptor
         */
        public void set(String attributeName, ISOAttributeTypeBuilder attributeBuilder){
	...
	/**
        ...
        public static SimpleFeatureType retype( SimpleFeatureType original,CoordinateReferenceSystem crs ) {
            ...
            for( AttributeDescriptor descriptor : original.getAttributeDescriptors() ){
                if( descriptor instanceof GeometryDescriptor ){
                    ...
                    ISOAttributeTypeBuilder adjust = new ISOAttributeTypeBuilder( b.factory );
        ...
        public static SimpleFeatureType copy( SimpleFeatureType original ) {
            ...
            //add attributes in order
            for( AttributeDescriptor descriptor : original.getAttributeDescriptors() ){
                ISOAttributeTypeBuilder ab = new ISOAttributeTypeBuilder( b.factory );
                ab.init( descriptor );
