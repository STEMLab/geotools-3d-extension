 ...
 * @source $URL$
 */
public class ISOFilterAttributeExtractor extends DefaultFilterVisitor {
     ...
     */
    public ISOFilterAttributeExtractor() {
        this(null);
    }
    /**
     ...
     * @param featureType
     */
    public ISOFilterAttributeExtractor(SimpleFeatureType featureType) {
    ...
    public Object visit(org.opengis.filter.expression.Function expression, Object data) {
        ...
        if(expression instanceof FilterFunction_property) {
            ...
            if(expression.getParameters() != null && expression.getParameters().size() > 0) {
                ...
                ISOFilterAttributeExtractor secondary = new ISOFilterAttributeExtractor();
