...
/**
 * this class is cloned from org.geotools.filter.Filters in gt-main module in order to supports ISO Geometry.
 */
public class ISOFilters {
    ...
    public ISOFilters() {
        ...
        this(new ISOFilterFactoryImpl());
    }
    /** Create a Filters helper using the provided FilterFactory */
    public ISOFilters(org.opengis.filter.FilterFactory2 factory) {
        ff = factory;
    }
