 ...
 */
public abstract class ISOGeometryFilterImpl extends BinaryComparisonAbstract
    ...
    @Deprecated
    protected ISOGeometryFilterImpl() throws IllegalFilterException {
    }

    protected ISOGeometryFilterImpl(MatchAction matchAction) {
        this.matchAction = matchAction;
    }

    protected ISOGeometryFilterImpl(org.opengis.filter.expression.Expression e1,
            org.opengis.filter.expression.Expression e2, MatchAction matchAction) {
        super(e1, e2);
        this.matchAction = matchAction;
    }

    protected ISOGeometryFilterImpl(org.opengis.filter.FilterFactory factory) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ISOGeometryFilterImpl) {
            ISOGeometryFilterImpl geomFilter = (ISOGeometryFilterImpl) obj;
