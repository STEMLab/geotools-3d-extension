 ...
 * @source $URL$
 */
public class FilterFunction_ISOdistance extends FunctionExpressionImpl {

    public static FunctionName NAME = new FunctionNameImpl("ISOdistance", Double.class,
            parameter("geometry1", Geometry.class),
            parameter("geometry2", Geometry.class));

    public FilterFunction_ISOdistance() {
        super(NAME);
    }
    ...
    public Object evaluate(Object feature) {
        ...
        return (StaticGeometry.distance(arg0, arg1));
    }
}
