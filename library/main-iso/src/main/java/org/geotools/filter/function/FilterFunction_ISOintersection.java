 ...
 * @source $URL$
 */
public class FilterFunction_ISOintersection extends FunctionExpressionImpl  {
    public static FunctionName NAME = new FunctionNameImpl("ISOintersection", Geometry.class, 
            parameter("geometry1", Geometry.class), 
            parameter("geometry2", Geometry.class));

    public FilterFunction_ISOintersection() {
        super(NAME);
    }
