 ...
 * @source $URL$
 */
public class FilterFunction_ISOunion extends FunctionExpressionImpl {

    public static FunctionName NAME = new FunctionNameImpl("ISOunion",
            parameter("ISOunion", Geometry.class),
            parameter("geometry", Geometry.class),
            parameter("geometry", Geometry.class));

    public FilterFunction_ISOunion() {
        super(NAME);
    }
