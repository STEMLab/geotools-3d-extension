 ...
 * @source $URL$
 */
public class BBOXISOImpl extends AbstractPreparedGeometryFilter implements BBOX {
    ...
    public BBOXISOImpl(Expression e1, Expression e2) {
        super(e1, e2);
        if (e1 != null)
            setExpression1(e1);
        if (e2 != null)
    ...
    public BBOXISOImpl(Expression name, double minx, double miny, double maxx, double maxy, String srs) {
        this(name,
    ...
    public BBOXISOImpl(Expression e1, Expression e2, MatchAction matchAction) {
    ...
    public BBOXISOImpl(Expression name, double minx, double miny, double maxx, double maxy,
