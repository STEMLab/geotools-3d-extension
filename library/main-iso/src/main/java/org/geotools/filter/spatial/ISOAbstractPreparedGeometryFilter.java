 ...
 * @source $URL$
 */
public abstract class ISOAbstractPreparedGeometryFilter extends ISOGeometryFilterImpl {
    ...
    protected ISOAbstractPreparedGeometryFilter(Expression e1, Expression e2) {
        super(e1, e2);
    ...
    protected ISOAbstractPreparedGeometryFilter(Expression e1, Expression e2, MatchAction matchAction) {
