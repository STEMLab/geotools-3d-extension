 ...
 * @source $URL$
 */
public class ISOReprojectingFilterVisitor extends ISODuplicatingFilterVisitor {
    FeatureType featureType;

    public ISOReprojectingFilterVisitor(FilterFactory2 factory, FeatureType featureType) {
        super(factory);
    ...
    public Object visit(PropertyIsEqualTo filter, Object extraData) {
        return new BinaryComparisonTransformer() {
            ...
            Object cloneFilter(BinaryComparisonOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((PropertyIsEqualTo) filter, extraData);
            }
    ...
    public Object visit(PropertyIsNotEqualTo filter, Object extraData) {
        return new BinaryComparisonTransformer() {
            ...
            Object cloneFilter(BinaryComparisonOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((PropertyIsNotEqualTo) filter, extraData);
            }
    ...
    public Object visit(Beyond filter, Object extraData) {
        return new GeometryFilterTransformer() {
            ...
            Object cloneFilter(BinarySpatialOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((Beyond) filter, extraData);
            }
    ...
    public Object visit(Contains filter, Object extraData) {
        return new GeometryFilterTransformer() {
            ...
            Object cloneFilter(BinarySpatialOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((Contains) filter, extraData);
            }
    ...
    public Object visit(Crosses filter, Object extraData) {
        return new GeometryFilterTransformer() {
            ...
            Object cloneFilter(BinarySpatialOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((Crosses) filter, extraData);
            }
    ...
    public Object visit(Disjoint filter, Object extraData) {
        return new GeometryFilterTransformer() {
            ...
            Object cloneFilter(BinarySpatialOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((Disjoint) filter, extraData);
            }
    ...
    public Object visit(DWithin filter, Object extraData) {
        return new GeometryFilterTransformer() {
            ...
            Object cloneFilter(BinarySpatialOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((DWithin) filter, extraData);
            }
    ...
    public Object visit(Intersects filter, Object extraData) {
        return new GeometryFilterTransformer() {
            ...
            Object cloneFilter(BinarySpatialOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((Intersects) filter, extraData);
            }
    ...
    public Object visit(Overlaps filter, Object extraData) {
        return new GeometryFilterTransformer() {
            ...
            Object cloneFilter(BinarySpatialOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((Overlaps) filter, extraData);
            }
    ...
    public Object visit(Touches filter, Object extraData) {
        return new GeometryFilterTransformer() {
            ...
            Object cloneFilter(BinarySpatialOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((Touches) filter, extraData);
            }
    ...
    public Object visit(Within filter, Object extraData) {
        return new GeometryFilterTransformer() {
            ...
            Object cloneFilter(BinarySpatialOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((Within) filter, extraData);
            }
    ...
    public Object visit(Equals filter, Object extraData) {
        return new GeometryFilterTransformer() {
            ...
            Object cloneFilter(BinarySpatialOperator filter, Object extraData) {
                return ISOReprojectingFilterVisitor.super.visit((Equals) filter, extraData);
            }
    ...
    protected Geometry reproject( Object value, CoordinateReferenceSystem propertyCrs) {
        ...
        // there is no case CRS is null when we use ISO Geometry.
    ...
    private abstract class GeometryFilterTransformer {
        Object transform(final BinarySpatialOperator filter, Object extraData) {
            ...
            Expression ex1 =  (Expression) filter.getExpression1().accept(
                    ISOReprojectingFilterVisitor.this, extraData);
    ...
    private abstract class BinaryComparisonTransformer {
        Object transform(BinaryComparisonOperator filter, Object extraData) {
            ...
            // "transformed" expressions
            Expression ex1 =  (Expression) name.accept(ISOReprojectingFilterVisitor.this, extraData);
            Expression ex2 = reproject(other, propertyCrs, false);
            if(ex2 == null)
                ex2 = (Expression) other.accept(ISOReprojectingFilterVisitor.this, extraData);
