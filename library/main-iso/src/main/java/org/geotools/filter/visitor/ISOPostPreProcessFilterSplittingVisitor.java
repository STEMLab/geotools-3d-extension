 ...
 */
public class ISOPostPreProcessFilterSplittingVisitor implements FilterVisitor, ExpressionVisitor {
	     ...
	     */
	    public ISOPostPreProcessFilterSplittingVisitor(FilterCapabilities fcs, SimpleFeatureType parent, ClientTransactionAccessor transactionAccessor) {
	        this.fcs = fcs;
	        this.parent = parent;
