...
public class Util {
	public static Coordinate[] getCoordinateArray(Geometry geom) {
	...
	public static Solid makeSolidFromEnvelope(ISOGeometryBuilder builder, DirectPosition l, DirectPosition u) {
