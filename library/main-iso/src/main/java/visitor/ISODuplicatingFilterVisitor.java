 ...
 * @source $URL$
 */
public class ISODuplicatingFilterVisitor implements FilterVisitor, ExpressionVisitor {

	protected final FilterFactory2 ff;

	public ISODuplicatingFilterVisitor() {
		this(new ISOFilterFactoryImpl());
		
	}
	
	public ISODuplicatingFilterVisitor(FilterFactory2 factory) {
		this.ff = factory;
	}
