...
public class SDOCreateTest {
    ...
    public void testXY_Point() throws Exception {
        ...
        checkValue(oraGeom, 2, "POINT (50 50)");
    }
    ...
    public void testXYZ_LineString() throws Exception {
        ...
        checkValue(oraGeom, 3, "CURVE (0 0 0, 50 50 100)");
    }
    ...
    public void testXYM_LineString() throws Exception {
        ...
        checkValue(oraGeom, 2, "LINESTRING (1 1, 2 2)");
    }
    ...
    void checkValue(SDO_GEOMETRY oraGeom, String wkt) {
        checkValue(oraGeom, 2, wkt);
    }

    void checkValue(SDO_GEOMETRY oraGeom, int targetDim, String wkt) {
    	CoordinateReferenceSystem defaultCRS = null;
    	if(targetDim == 2){
    		defaultCRS = DefaultGeographicCRS.WGS84;
    	}
    	else if(targetDim == 3){
    		defaultCRS = DefaultGeographicCRS.WGS84_3D;
    	}
    	else{
    		throw new UnsupportedOperationException("Supported target dim only 2 and 3");
    	}
    	final ISOGeometryBuilder geometryFactory = new ISOGeometryBuilder(defaultCRS);
        WKTReader wktRdr = new WKTReader(defaultCRS);	
    ...
    private Object create(SDO_GEOMETRY oraGeom, ISOGeometryBuilder gf) {
