...
import org.geotools.jdbc3d.JDBCDelegatingTestSetup;
...
public class PostGISCurvesTestSetup extends JDBCDelegatingTestSetup {
    ...
    private void createCurvesTable() throws Exception {
        ...
        sql = "INSERT INTO CURVES VALUES (2, 'Compound line string', ST_geometryFromText('COMPOUNDCURVE((10 45, 20 45), "
        ...
        sql = "INSERT INTO CURVES VALUES (7, 'Multipolygon with curves', ST_geometryFromText('MULTISURFACE(CURVEPOLYGON("
