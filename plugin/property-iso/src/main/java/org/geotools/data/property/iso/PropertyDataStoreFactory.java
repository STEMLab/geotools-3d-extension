...
/**
 * DataStore factory that creates {@linkplain org.geotools.data.property.iso.PropertyDataStore}s
 *
 * @author Jody Garnett
...
public class PropertyDataStoreFactory implements DataStoreFactorySpi {
    ...
    public String getDescription() {
        return "Allows access to Java Property files containing Feature information using ISO Geometry";
    }
     ...
     */
    private File directoryLookup(Map<String, Serializable> params) throws IOException, FileNotFoundException,
