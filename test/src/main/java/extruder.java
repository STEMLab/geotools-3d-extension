			...
			if (result == JWizard.FINISH) {
				...
				while (iterator.hasNext()) {
					...
					double tempHeight = (double) feature.getAttribute("BUILDING_H");
			          ...
			          SimpleFeature saveFeature = fw.next();
			          saveFeature.setAttribute("geometry", feature.getAttribute("the_geom"));
			          saveFeature.setAttribute("id",feature.getAttribute("FeatureIdentifer"));
			          saveFeature.setAttribute("height", tempHeight);
			          fw.write();
			          //save this at table	
