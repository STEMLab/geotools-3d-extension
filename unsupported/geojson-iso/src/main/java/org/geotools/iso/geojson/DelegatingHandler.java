...
import org.geotools.iso.geojson.feature.FeatureCollectionHandler;
import org.geotools.iso.geojson.feature.FeatureHandler;
import org.geotools.iso.geojson.geom.CurveHandler;
import org.geotools.iso.geojson.geom.MultiCurveHandler;
import org.geotools.iso.geojson.geom.MultiPointHandler;
import org.geotools.iso.geojson.geom.MultiPrimitiveHandler;
import org.geotools.iso.geojson.geom.MultiSurfaceHandler;
import org.geotools.iso.geojson.geom.PointHandler;
import org.geotools.iso.geojson.geom.SurfaceHandler;
...
public abstract class DelegatingHandler<T> implements IContentHandler<T> {
    ...
    static {
        ...
        handlers.put("LineString", CurveHandler.class);
        handlers.put("Polygon", SurfaceHandler.class);
        handlers.put("MultiPoint", MultiPointHandler.class);
        handlers.put("MultiLineString", MultiCurveHandler.class);
        handlers.put("MultiPolygon", MultiSurfaceHandler.class);
        handlers.put("GeometryCollection", MultiPrimitiveHandler.class);
