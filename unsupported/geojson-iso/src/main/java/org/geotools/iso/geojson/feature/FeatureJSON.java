...
import static org.geotools.iso.geojson.GeoJSONUtil.array;
import static org.geotools.iso.geojson.GeoJSONUtil.entry;
import static org.geotools.iso.geojson.GeoJSONUtil.string;
...
public class FeatureJSON {
    ...
    public SimpleFeature readFeature(Object input) throws IOException {
        return GeoJSONUtil.parse(new FeatureHandler(
            featureType != null ? new ISOSimpleFeatureBuilder(featureType): null, attio
        ), input, false);
    }
