...
public class EdgeEndBuilder {
	...
	/**
	 * Create a EdgeStub for the edge before the intersection eiCurr. The
	 * previous intersection is provided in case it is the endpoint for the stub
	 * edge. Otherwise, the previous point from the parent edge will be the
	 * endpoint. <br>
	 ...
	 * @param eiPrev
	 */
	private void createEdgeEndForPrev(Edge edge, List l, EdgeIntersection eiCurr,
	 ...
	 * @param eiNext
	 */
	private void createEdgeEndForNext(Edge edge, List l, EdgeIntersection eiCurr,
