 ...
 *
 */
public class SFCGALConvertorNG {
        ...
        public static SFGeometry geometryToSFCGALGeometry(Geometry geom) {
                ...
                if (geom instanceof DirectPositionImpl) {
                        geometry = SFCGALConvertorNG
                                        .directPositionToSFCGALPoint((DirectPosition) geom);
                } else if (geom instanceof PointImpl) {
                        geometry = SFCGALConvertorNG.pointToSFCGALPoint((Point) geom);
                } else if (geom instanceof CurveImpl) {
                        geometry = SFCGALConvertorNG.curveToSFCGALLineString((Curve) geom);
                } else if (geom instanceof RingImplUnsafe) {
                        geometry = SFCGALConvertorNG.ringToSFCGALLineString((Ring) geom);
                        ...
                        if (patches.size() == 1 && (patch instanceof TriangleImpl)) {
                                ...
                                geometry = SFCGALConvertorNG.surfaceToSFCGALPolygon((Surface) geom);
                        }
                        ...
                        geometry = SFCGALConvertorNG.solidToSFCGALSolid((Solid) geom);
                        ...
                        geometry = SFCGALConvertorNG.multiPointToSFCGALMultiPoint((MultiPoint) geom);
