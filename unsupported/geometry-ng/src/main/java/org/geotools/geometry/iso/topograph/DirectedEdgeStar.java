...
public class DirectedEdgeStar extends EdgeEndStar {
	...
	/**
	 * For each dirEdge in the star, merge the label from the sym dirEdge into
	 * the label
	 */
	 ...
	 * To link two dirEdges, the <next> pointer for an incoming dirEdge is set
	 ...
	 * area at this node (if any). If any L edges are found in the interior of
	 * the result, mark them as covered.
	 */
	 ...
	 * 
	 * @return the last depth assigned (from the R side of the last edge
	 *         visited)
	 */
