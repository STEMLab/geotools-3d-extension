...
public class TopologyLocation {
	...
	/**
	 * Constructs a TopologyLocation specifying how points on, to the left of,
	 * and to the right of some GraphComponent relate to some Geometry. Possible
	...
	public void merge(TopologyLocation gl) {
		// if the src is an Area label & and the dest is not, increase the dest
		// to be an Area
