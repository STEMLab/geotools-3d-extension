...
import org.geotools.geometry.iso.topograph.CoordinateList;
...
public class CoordinateArrays {
	 ...
	 * "smaller" (using the standard ordering on {@link Coordinate}). Returns
	...
	/**
	 * Returns the index of <code>coordinate</code> in
	 * <code>coordinates</code>. The first position is 0; the second, 1; etc.
	 * 
	 * @param coordinate
	 *            the <code>Coordinate</code> to search for
	 * @param coordinates
	 *            the array to search
	 * @return the position of <code>coordinate</code>, or -1 if it is not
	 *         found
	 */
	...
	/**
	 * SJ TODO faellt evtl weg, wenn coordinate durch DirectPosition
	 * ausgetauscht wird
	 * 
	 * @param aPositions
	 * @return
	 ...
	 * 
	 * SJ: faellt evtl weg, wenn coordinate durch DirectPosition
	 * ausgetauscht wird
	 * 
	 * @param coordArray
	 * @return
