...
public class SolidUtil {
	...
	public static Surface createSurface(ISOGeometryBuilder gb3D, List<DirectPosition> upper) { 
		// create one surface
	 ...
	 * List<DirectPosition>points; OrientableSurface os =
	 * (OrientableSurface)s.getBoundary(); List<OrientableCurve>cl =
	 * (List<OrientableCurve>) os.getBoundary();
	 * 
	 * }
	 */
