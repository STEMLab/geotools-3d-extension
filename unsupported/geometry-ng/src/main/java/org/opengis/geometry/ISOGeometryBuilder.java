 ...
 * @source $URL$
 */
public class ISOGeometryBuilder {
    /**
    ...
    private PrimitiveFactory2 primitiveFactory;
    private AggregateFactory aggregateFactory;
    private ComplexFactory complexFactory;
    private GeometryFactory geometryFactory;
    
    public ISOGeometryBuilder( CoordinateReferenceSystem crs ){
        this.crs = crs;
    ...
    public ISOGeometryBuilder( Hints hints ){
    ...
    public PositionFactory getPositionFactory() {
        if( positionFactory == null ){
            ...
            positionFactory = ISOGeometryFactoryFinder.getPositionFactory( hints);
        }
        return positionFactory;
    }

    public PrimitiveFactory2 getPrimitiveFactory() {
        if( primitiveFactory == null ){
            ...
            primitiveFactory = ISOGeometryFactoryFinder.getPrimitiveFactory(  hints);
        }
        return primitiveFactory;
    }
    ...
    public AggregateFactory getAggregateFactory() {
        if( aggregateFactory == null ){
        	...
        	aggregateFactory = ISOGeometryFactoryFinder.getAggregateFactory( hints);
        }
        return aggregateFactory;
    }
    ...
    public GeometryFactory getGeometryFactory() {
        if( geometryFactory == null ){
            ...
            geometryFactory = ISOGeometryFactoryFinder.getGeometryFactory(  hints);
        }
        return geometryFactory;
    }
    ...
    public ComplexFactory getComplexFactory() {
        if( complexFactory == null ){
        	...
        	complexFactory = ISOGeometryFactoryFinder.getComplexFactory(  hints);
        }
        return complexFactory;
    }    
