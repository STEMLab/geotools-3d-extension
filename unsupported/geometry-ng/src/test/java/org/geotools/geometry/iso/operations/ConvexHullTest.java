...
public class ConvexHullTest extends TestCase {
	...
	private void _testPoints() {
		...
		assertTrue(pos.get(0).getOrdinate(0) == 30);
		assertTrue(pos.get(0).getOrdinate(1) == 50);
		assertTrue(pos.get(1).getOrdinate(0) == 70);
		assertTrue(pos.get(1).getOrdinate(1) == 10);
		assertTrue(pos.get(2).getOrdinate(0) == 170);
		assertTrue(pos.get(2).getOrdinate(1) == 10);
		assertTrue(pos.get(3).getOrdinate(0) == 100);
		assertTrue(pos.get(3).getOrdinate(1) == 120);
		assertTrue(pos.get(4).getOrdinate(0) == 30);
		assertTrue(pos.get(4).getOrdinate(1) == 50);
	...
	private void _testCurves() {
		...
		assertTrue(dpos.get(0).getOrdinate(0) == 10);
		assertTrue(dpos.get(0).getOrdinate(1) == 50);
		assertTrue(dpos.get(1).getOrdinate(0) == 30);
		assertTrue(dpos.get(1).getOrdinate(1) == 20);
		assertTrue(dpos.get(2).getOrdinate(0) == 100);
		assertTrue(dpos.get(2).getOrdinate(1) == 70);
		assertTrue(dpos.get(3).getOrdinate(0) == 100);
		assertTrue(dpos.get(3).getOrdinate(1) == 120);
		assertTrue(dpos.get(4).getOrdinate(0) == 10);
		assertTrue(dpos.get(4).getOrdinate(1) == 140);
		...
		assertTrue(dpos.get(1).getOrdinate(0) == 30);
		assertTrue(dpos.get(1).getOrdinate(1) == 20);
		assertTrue(dpos.get(2).getOrdinate(0) == 40);
		assertTrue(dpos.get(2).getOrdinate(1) == 10);
		assertTrue(dpos.get(3).getOrdinate(0) == 100);
		assertTrue(dpos.get(3).getOrdinate(1) == 20);
		assertTrue(dpos.get(4).getOrdinate(0) == 100);
		assertTrue(dpos.get(4).getOrdinate(1) == 120);
		assertTrue(dpos.get(5).getOrdinate(0) == 10);
		assertTrue(dpos.get(5).getOrdinate(1) == 140);
		assertTrue(dpos.get(6).getOrdinate(0) == 10);
		assertTrue(dpos.get(6).getOrdinate(1) == 50);
	...
	private void _testSurfaces() {
		...
		List<DirectPosition> pos = this.surfaceToPositions((Surface) res);
		assertTrue(pos.get(0).getOrdinate(0) == 10);
		assertTrue(pos.get(0).getOrdinate(1) == 90);
		assertTrue(pos.get(1).getOrdinate(0) == 30);
		assertTrue(pos.get(1).getOrdinate(1) == 50);
		assertTrue(pos.get(2).getOrdinate(0) == 70);
		assertTrue(pos.get(2).getOrdinate(1) == 30);
		assertTrue(pos.get(3).getOrdinate(0) == 120);
		assertTrue(pos.get(3).getOrdinate(1) == 40);
		assertTrue(pos.get(4).getOrdinate(0) == 150);
		assertTrue(pos.get(4).getOrdinate(1) == 70);
		assertTrue(pos.get(5).getOrdinate(0) == 150);
		assertTrue(pos.get(5).getOrdinate(1) == 120);
		assertTrue(pos.get(6).getOrdinate(0) == 100);
		assertTrue(pos.get(6).getOrdinate(1) == 150);
		assertTrue(pos.get(7).getOrdinate(0) == 30);
		assertTrue(pos.get(7).getOrdinate(1) == 140);
		assertTrue(pos.get(8).getOrdinate(0) == 10);
		assertTrue(pos.get(8).getOrdinate(1) == 90);
		...
		assertTrue(pos.get(0).getOrdinate(1) == 50);
		assertTrue(pos.get(1).getOrdinate(0) == 100);
		assertTrue(pos.get(1).getOrdinate(1) == 10);
		assertTrue(pos.get(2).getOrdinate(0) == 170);
		assertTrue(pos.get(2).getOrdinate(1) == 20);
		assertTrue(pos.get(3).getOrdinate(0) == 200);
		assertTrue(pos.get(3).getOrdinate(1) == 90);
		assertTrue(pos.get(4).getOrdinate(0) == 160);
		assertTrue(pos.get(4).getOrdinate(1) == 140);
		assertTrue(pos.get(5).getOrdinate(0) == 90);
		assertTrue(pos.get(5).getOrdinate(1) == 100);
		assertTrue(pos.get(6).getOrdinate(0) == 70);
		assertTrue(pos.get(6).getOrdinate(1) == 50);
		...
		assertTrue(pos.get(1).getOrdinate(0) == 100);
		assertTrue(pos.get(1).getOrdinate(1) == 10);
		assertTrue(pos.get(2).getOrdinate(0) == 130);
		assertTrue(pos.get(2).getOrdinate(1) == 10);
		assertTrue(pos.get(3).getOrdinate(0) == 170);
		assertTrue(pos.get(3).getOrdinate(1) == 20);
		...
		assertTrue(pos.get(6).getOrdinate(0) == 90);
