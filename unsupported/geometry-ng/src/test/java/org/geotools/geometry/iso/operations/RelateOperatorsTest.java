...
//        System.out.println(ls.contains(p) + " " + ls.covers(p) + " " + p.within(ls) + " " + p.coveredBy(ls));
//    }
...
//		assertTrue(shouldBeCoveredBy == result);
	...
	private CompositeSurfaceImpl createCompositeSurfaceAwithoutHole() {
		String wktSurface = "SURFACE ((10 90, 30 50, 70 30, 120 40, 150 70, 150 120, 100 150, 30 140, 10 90))";
