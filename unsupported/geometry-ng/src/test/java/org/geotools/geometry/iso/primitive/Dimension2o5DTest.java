...
public class Dimension2o5DTest extends TestCase {
	...
	private void _testCurve1(ISOGeometryBuilder builder) {
...
//		//System.out.println("Intersection of curves: " + g);
	...
	private void _testSurface(ISOGeometryBuilder builder) {
	...
	private Curve _createCurve1(ISOGeometryBuilder builder) {
	...
	private Curve _createCurve2(ISOGeometryBuilder builder) {
		GeometryFactoryImpl tCoordFactory = (GeometryFactoryImpl) builder.getGeometryFactory();
		PrimitiveFactoryImpl tPrimFactory = (PrimitiveFactoryImpl) builder.getPrimitiveFactory();
	...
	private Surface _createSurface1(ISOGeometryBuilder builder) {
		GeometryFactoryImpl tCoordFactory = (GeometryFactoryImpl) builder.getGeometryFactory();
		PrimitiveFactoryImpl tPrimFactory = (PrimitiveFactoryImpl) builder.getPrimitiveFactory();
	...
	public Surface _createSurface2(ISOGeometryBuilder builder) {
		GeometryFactoryImpl tCoordFactory = (GeometryFactoryImpl) builder.getGeometryFactory();
		PrimitiveFactoryImpl tPrimFactory = (PrimitiveFactoryImpl) builder.getPrimitiveFactory();
