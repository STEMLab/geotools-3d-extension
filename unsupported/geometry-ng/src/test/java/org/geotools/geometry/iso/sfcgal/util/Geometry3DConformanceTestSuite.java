 ...
 * @source $URL$
 */
public class Geometry3DConformanceTestSuite extends TestSuite {

    public static Test suite() {
        GeometryTestParser parser = new GeometryTestParser();

        Geometry3DConformanceTestSuite suite = new Geometry3DConformanceTestSuite();

        File dir;
        try {
            dir = TestData.file(Geometry3DConformanceTestSuite.class, "Test3DTopologyAS.xml")
                    .getParentFile();
                ...
                for (int i = 0; i < strings.length; i++) {
                    ...
                    if (op != null) {
                        ...
                        if (operationValue.equalsIgnoreCase("skipped")) {
                            ...
                            try {
                                Object expectedResult = wktReader.read(operationValue);
