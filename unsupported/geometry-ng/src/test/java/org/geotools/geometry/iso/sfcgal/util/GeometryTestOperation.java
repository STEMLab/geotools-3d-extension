...
public class GeometryTestOperation extends Assert {
    ...
    private void setupOperationMap() {
        ...
        operationMap.put("within", new WithinOp());
        ...
        operationMap.put("touches", new TouchesOp());
        operationMap.put("crosses", new CrossesOp());
        operationMap.put("overlaps", new OverlapsOp());
    }
    ...
    /**
     * Class defining the "touches" operation
     */
    private class TouchesOp extends OperationHandler {
        /**
         * performs the touches on the two arguments
         * @param a Geometry object
         * @param b Geometry Object
         * @return a boolean indicating whether the result matched the expectation
         */
        public boolean doOperation(Geometry a, Geometry b) {
            GeometryImpl geom1 = (GeometryImpl) setGeomArg(arg1, a, b);
            GeometryImpl geom2 = (GeometryImpl) setGeomArg(arg2, a, b);
            boolean result = geom1.touches(geom2);
            actualResult = result;
            return (actualResult == expectedResult);
        }
    }
    ...
    /**
     * Class defining the "crosses" operation
     */
    private class CrossesOp extends OperationHandler {
        /**
         * performs the crosses on the two arguments
         * @param a Geometry object
         * @param b Geometry Object
         * @return a boolean indicating whether the result matched the expectation
         */
        public boolean doOperation(Geometry a, Geometry b) {
            GeometryImpl geom1 = (GeometryImpl) setGeomArg(arg1, a, b);
            GeometryImpl geom2 = (GeometryImpl) setGeomArg(arg2, a, b);
            boolean result = geom1.crosses(geom2);
            actualResult = result;
            return (actualResult == expectedResult);
        }
    }
    ...
    /**
     * Class defining the "overlaps" operation
     */
    private class OverlapsOp extends OperationHandler {
        /**
         * performs the overlaps on the two arguments
         * @param a Geometry object
         * @param b Geometry Object
         * @return a boolean indicating whether the result matched the expectation
         */
