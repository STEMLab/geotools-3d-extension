...
import org.geotools.graph.build.line.CurveGraphGenerator;
...
public class FeatureGraphGeneratorTest extends TestCase {
	...
	public void test() throws Exception {
		CurveGraphGenerator lsgg = new CurveGraphGenerator();
		ISOFeatureGraphGenerator fgg = new ISOFeatureGraphGenerator( new CurveGraphGenerator() );
