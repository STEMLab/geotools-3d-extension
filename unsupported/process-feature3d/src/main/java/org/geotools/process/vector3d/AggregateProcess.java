 ...
 * @source $URL$
 */
@DescribeProcess(title = "Aggregate3D", description = "Computes one or more aggregation functions on a feature attribute. Functions include Count, Average, Max, Median, Min, StdDev, and Sum.")
