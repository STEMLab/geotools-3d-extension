 ...
 * @source $URL$
 */
@DescribeProcess(title = "Collect Geometries3D", description = "Collects the deafult geometries of the input features and combines them into a single geometry collection")
