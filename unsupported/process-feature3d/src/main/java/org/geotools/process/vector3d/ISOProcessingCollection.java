 ...
 * @param <F>
 */
public abstract class ISOProcessingCollection<T extends FeatureType, F extends Feature>
        extends BaseFeatureCollection<T, F> {

    public ISOProcessingCollection() {
     ...
     * @deprecated Use {@link ISODataUtilities#count(org.geotools.feature.FeatureCollection)
     */
    protected int getFeatureCount() {
        return ISODataUtilities.count( this );
    }
    
    /**
     * Utility to get all the features to implement the toArray methods
     * @deprecated Use {@link ISODataUtilities#list(org.geotools.feature.FeatureCollection)}
     */
    protected List<F> toList() {
        return ISODataUtilities.list( this );
    }
    /**
     ...
     * @deprecated Use {@link ISODataUtilities#bounds(FeatureIterator)
     */
    protected ReferencedEnvelope getFeatureBounds() {
        return ISODataUtilities.bounds( features() );
    }
