 ...
 * 
 */
public abstract class ISOSimpleProcessingCollection extends
        ISOProcessingCollection<SimpleFeatureType, SimpleFeature> implements SimpleFeatureCollection {
    ...
    public SimpleFeatureCollection subCollection(Filter filter) {
        return ISODataUtilities.simple(super.subCollection(filter));
    }
}
