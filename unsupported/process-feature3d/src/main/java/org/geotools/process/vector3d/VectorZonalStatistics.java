...
import org.geotools.process.vector3d.AggregateProcess.AggregationFunction;
import org.geotools.process.vector3d.AggregateProcess.Results;
 ...
 */
@DescribeProcess(title = "Vector Zonal Statistics3D", description = "Computes statistics for the distribution of a given attribute in a set of polygonal zones.  Input must be points.")
