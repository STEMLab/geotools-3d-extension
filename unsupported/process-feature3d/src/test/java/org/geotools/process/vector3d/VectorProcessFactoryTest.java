...
import org.geotools.process.vector3d.VectorProcess;
import org.geotools.process.vector3d.VectorProcessFactory;
...
public class VectorProcessFactoryTest {
    ...
    public void testLookup() {
        ...
        assertTrue(names.contains(new NameImpl("vec3D", "Aggregate")));
    }
    ...
    public void testAddCustomProcess() {
        ...
        try {
            Processors.reset();
            assertNotNull(Processors.createProcess(new NameImpl("vec3D", "Custom")));
        }
        finally {
